...
If you are using Unity and want to get up an running right away you can open the "fantasy-rune-weapons.unitypackage".

If not you can import the weapons one by one using their seperate folders.
